# ocean_sound_lab v4.2.3-41

Summary
- Prebuilt binary and runtime distribution for release 4.2.3-41 (tarball).

![Ocean-SL screenshot](Resource/Ocean-SL.png)

what's included
- ocean_sound_lab_4.2.3-41.tar.gz - prebuilt binaries for linux x86_64, aarch64, Ubuntu libc.so.6
...
2. Extract:
   tar -xzf ocean_sound_lab_4.2.3-41.tar.gz
3. Follow the install.txt inside the extracted folder for runtime/setup instructions.

Verification
		- verify cksum (as provided by packager):
		2373599727 128189886 ocean_sound_lab_4.2.3-41.tar.gz
- verify SHA-256 locally: 
162759707a318b9a4015e7f4eee94a1c084fd3576865ae081e210bca3d7ea7df  ocean_sound_lab_4.2.3-41.tar.gz
- Verify: shasum -a 256 -c ocean_sound_lab_4.2.3-41.tar.gz.sha256
...
https://github.com/uglasmeyer/ocean/releases/tag/v4.2.3-41
